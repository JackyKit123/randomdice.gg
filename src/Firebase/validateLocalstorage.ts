      ...
      return (
        ...
        data.every(
          datum =>
            ...
            datum.guide?.every((guide: unknown) => typeof guide === 'number') &&
            ...
            datum.decks?.every(
              (deck: unknown) =>
                Array.isArray(deck) &&
                deck.every((die: unknown) => typeof die === 'number')
            )
        )
      );
    case 'dice':
      return (
        ...
        data.every(
          datum =>
            ...
            /(?:Front|Strongest|Random|Weakest|-)/i.test(datum.target) &&
            /(?:Common|Rare|Unique|Legendary)/i.test(datum.rarity) &&
        ...
        return (
          ...
          tips.every(
            tip =>
              ...
              /(?:Beginners|Intermediate|Advanced)/.test(tip.level)
          ) &&
    ...
    case 'critData':
      return (
        ...
        Object.values(data).every(
          val =>
            typeof val.trophies === 'number' && typeof val.crit === 'number'
        )
      );
    case 'patreon_list':
      return (
        ...
        data.every(datum => {
          if (
            ...
            const { id } = datum;
            return (
              (datum[id] !== null && typeof datum[id] === 'undefined') ||
    ...
    default:
      if (key.match(/^users\/.+/)) {
        if (typeof data === 'object' && data !== null) {
          ...
          if (
            (typeof (data as UnknownData)['linked-account'] === 'object' &&
              (typeof (data as UnknownData)['patreon-tier'] === 'number' ||
                typeof (data as UnknownData)['patreon-tier'] === 'undefined') &&
            ...
            return (
              (typeof discord === 'undefined' || typeof discord === 'string') &&
              (typeof patreon === 'undefined' || typeof patreon === 'string')
            );
          }

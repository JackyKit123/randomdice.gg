  ...
  return (
    <main>
      ...
      <div className={`banner ${!online ? 'offline' : ''}`}>
        ...
        {!online ? (
          <span>
            You are currently offline, please check your connection, content of
            this website will continue to be served.
          </span>
        ) : null}
      </div>
      <div className={`main ${className}`}>
        {disallowAd ? null : <GoogleAds noHrDivisor unitId='5526854380' />}

...
export default function GoogleAds({
  ...
  return (
    <div className={`ad-container ${detected() ? 'adblocked' : ''}`}>
      {detected() ? (
        <span>
          If you can see this message, that most likely means that you have an
          Ad Blocker running. We rely on advertising to keep this website alive!
          We kindly ask you to disable your AdBlock. Or if you want Ad free
          browsing, you can support us on{' '}
          <a

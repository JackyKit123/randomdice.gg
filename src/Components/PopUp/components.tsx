...
import { loginDiscord, loginPatreon } from 'Firebase/auth';
    ...
    return (
        <>
            ...
            <span>
                ...
                current moment. You may not need to login to use this website.
                There is no hidden content requiring a login.
            </span>
            <span>

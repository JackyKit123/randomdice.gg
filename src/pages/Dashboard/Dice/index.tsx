          ...
          onChange={(evt): void => {
            if (evt.target.value === '?') {
              ...
              if (foundDice) {
                ...
                let newId = dices.findIndex((dice, i) => dice.id !== i);
                if (newId === -1) {
                  newId = dices.length;
                }
      ...
      {activeEdit.id === -1 ? null : (
        <>
          <form onSubmit={(evt): void => evt.preventDefault()}>
            ...
            {invalidName ? (
              <div className='invalid-warning'>
                Do not include the word &apos;dice&apos; in the name, trim the
            ...
            <label htmlFor='dice-type'>
              ...
              <select
                ...
                onChange={(evt): void => {
                  activeEdit.type = evt.target.value as Die['type'];
                  setActiveEdit({ ...activeEdit });
                }}
              >
            ...
            <label htmlFor='dice-target'>
              ...
              <select
                ...
                onChange={(evt): void => {
                  activeEdit.target = evt.target.value as Die['target'];
                  setActiveEdit({ ...activeEdit });
                }}
              >
                <option>-</option>
            ...
            <label htmlFor='dice-rarity'>
              ...
              <select
                ...
                onChange={(evt): void => {
                  activeEdit.rarity = evt.target.value as Die['rarity'];
                  setActiveEdit({ ...activeEdit });
                }}
              >
            ...
            <label htmlFor='dice-cupAtk'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.cupAtk = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            <label htmlFor='dice-pupAtk'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.pupAtk = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            ...
            <label htmlFor='dice-cupSpd'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.cupSpd = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            <label htmlFor='dice-pupSpd'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.pupSpd = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            ...
            <label htmlFor='dice-cupEff1'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.cupEff1 = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            <label htmlFor='dice-pupEff1'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.pupEff1 = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            ...
            <label htmlFor='dice-cupEff2'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.cupEff2 = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
            <label htmlFor='dice-pupEff2'>
              ...
              <input
                ...
                type='number'
                onChange={(evt): void => {
                  activeEdit.pupEff2 = Number(evt.target.value);
                  setActiveEdit({ ...activeEdit });
                }}
              />
            </label>
              ...
              <>
                ...
                <label htmlFor='dice-arena-type'>
                  ...
                  <select
                    ...
                    defaultValue={activeEdit.arenaValue.type}
                    onChange={(evt): void => {
                      activeEdit.arenaValue.type = evt.target
                ...
                <label htmlFor='dice-arena-dps'>
                  ...
                  <input
                    ...
                    className={invalidArenaDps ? 'invalid' : ''}
                    defaultValue={activeEdit.arenaValue.dps}
                    type='number'
                    onChange={(evt): void => {
                      activeEdit.arenaValue.dps = Number(evt.target.value);
                      setActiveEdit({ ...activeEdit });
                    }}
                  />
                </label>
                <label htmlFor='dice-arena-slow'>
                  ...
                  <input
                    ...
                    className={invalidArenaSlow ? 'invalid' : ''}
                    defaultValue={activeEdit.arenaValue.slow}
                    type='number'
                    onChange={(evt): void => {
                      activeEdit.arenaValue.slow = Number(evt.target.value);
                      setActiveEdit({ ...activeEdit });
                    }}
                  />
                </label>
                <label htmlFor='dice-arena-assist'>
                  ...
                  <input
                    ...
                    className={invalidArenaAssist ? 'invalid' : ''}
                    defaultValue={activeEdit.arenaValue.assist}
                    type='number'
                    onChange={(evt): void => {
                      activeEdit.arenaValue.assist = Number(evt.target.value);
                      setActiveEdit({ ...activeEdit });
                    }}
                  />
                </label>
                <label htmlFor='dice-arena-value'>
                  ...
                  <input
                    ...
                    className={invalidArenaValue ? 'invalid' : ''}
                    defaultValue={activeEdit.arenaValue.value}
                    type='number'
                    onChange={(evt): void => {
                      activeEdit.arenaValue.value = Number(evt.target.value);
                      setActiveEdit({ ...activeEdit });
                    }}
                  />
                </label>
              ...
              <>
                ...
                <label htmlFor='dice-alt-desc'>
                  ...
                  <input
                    ...
                    defaultValue={activeEdit.alternatives?.desc}
                    type='textbox'
                    onChange={(evt): void => {
                      ...
                      activeEdit.alternatives.desc = evt.target.value;
                      setActiveEdit({ ...activeEdit });
                    }}
                  />
                </label>
                <label htmlFor='dice-alt-1'>
                  ...
                  <select
                    ...
                    defaultValue={activeEdit.alternatives?.list?.[0] || '?'}
                    onChange={(evt): void => {
                      activeEdit.alternatives = activeEdit.alternatives || {
                        desc: '',
                        list: [],
                ...
                <label htmlFor='dice-alt-2'>
                  ...
                  <select
                    ...
                    defaultValue={activeEdit.alternatives?.list?.[1] || '?'}
                    onChange={(evt): void => {
                      activeEdit.alternatives = activeEdit.alternatives || {
                        desc: '',
                        list: [],
                  ...
                  >
                    <option>?</option>
                    {dices.map(dice => (
                      <option key={dice.name} value={dice.id}>
                        {dice.name}
                      </option>
                    ))}
                  </select>
                ...
                <label htmlFor='dice-alt-3'>
                  ...
                  <select
                    ...
                    defaultValue={activeEdit.alternatives?.list?.[2] || '?'}
                    onChange={(evt): void => {
                      activeEdit.alternatives = activeEdit.alternatives || {
                        desc: '',
                        list: [],
                ...
                <label htmlFor='dice-alt-4'>
                  ...
                  <select
                    ...
                    defaultValue={activeEdit.alternatives?.list?.[3] || '?'}
                    onChange={(evt): void => {
                      activeEdit.alternatives = activeEdit.alternatives || {
                        desc: '',
                        list: [],
                ...
                <label htmlFor='dice-alt-5'>
                  ...
                  <select
                    ...
                    defaultValue={activeEdit.alternatives?.list?.[4] || '?'}
                    onChange={(evt): void => {
                      activeEdit.alternatives = activeEdit.alternatives || {
                        desc: '',
                        list: [],

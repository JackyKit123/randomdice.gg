...
export default function DpsCalculator(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                This is a calculator for calculating the dps for generic dice
                that have no special interactions or effect and instead they
                attack plain basic attack damage.
            </p>
            <p>
                We have only included damage dealer dice like typhoon. Value
                dice or slow dice dps is ignored as their dps in negligible. For
                dice with special interaction like Solar, Gear or Combo, please
                refer to the tab for more information.
            </p>
            <p>
                Moreover, dice that deals AOE damage is not included. This
                includes Landmine, Thorn, Infect, etc. Basically, only meta dps
                dice are included. You can request for more calculators for
                other dice and your suggestion may be considered and we will
                make more calculators.
            </p>
                ...
                <div className='boss-dmg'>
                    ...
                    <label htmlFor='result'>
                        ...
                        <input
                            ...
                            className={invalidInput ? 'invalid' : ''}
                            value={
                                invalidInput ? 'Check Input' : electricDps(true)
                            }
                            disabled
                        />
                    </label>
            ...
            <hr className='divisor' />
            <p>
                The chart below updates according to the information you input
                above, so you can enter the your dice class and read the
                expected dps below.
            </p>

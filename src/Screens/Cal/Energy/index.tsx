...
export default function EnergyCalculator(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                This is a calculator for calculating the Energy Dice damage. You
                can see the dps of energy raw damage and the dps of energy when
                it is buffed by Light, Critical or Lunar Dice.
            </p>
            <p>
                Do Remember that damage and dps shown is per pip. You will have
                to multiply the total pip count on your board to get the final
                dps.
            </p>
            ...
            <div className='chart-container'>
                <VictoryChart
                    ...
                    maxDomain={{
                        ...
                        y:
                            Math.max(
                                dpsPerSpCount('crit', filter.energy.sp + 100)
                                    .dps,
                                dpsPerSpCount('lunar', filter.energy.sp + 100)
                                    .dps
                            ) + 10,
                    }}

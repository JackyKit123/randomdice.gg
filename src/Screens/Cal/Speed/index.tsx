    ...
    return (
        ...
        >
            <p>
                ...
                Slow from frost effect by ice and blizzard is 3 Frost layers,
                which is 50% maxed. Flow has no speed cap in pvp while having
                40% max slow in co-op. We do not have accurate data for the slow
                effect for sand swamp and we assumed it to be 40%.
            </p>
            ...
            <div className='result'>
                ...
                <label htmlFor='result'>
                    ...
                    <input
                        className={
                            invalidFlowPip || invalidFlowCount ? 'invalid' : ''
                        }
                        type='textbox'
                        value={

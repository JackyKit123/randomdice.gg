...
export default function ComboCalculator(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                This is a calculator for calculating the Combo Dice damage. You
                can see the dps of combo raw damage and the dps of combo when it
                is buffed by Critical and Lunar Dice.
            </p>
            <p>
            ...
            <div className='chart-container'>
                <VictoryChart
                    ...
                    maxDomain={{
                        ...
                        y: Math.max(
                            dpsPerComboCount('lunar', filter.combo.count + 10)
                                .dps,
                            dpsPerComboCount('crit', filter.combo.count + 10)
                                .dps
                        ),
                    }}

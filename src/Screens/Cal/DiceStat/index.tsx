...
export default function DiceStat(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                This is a basic stat calculator for every dice. Note that the
                pip count variable is not taken into account. It only depicts
                the raw stat, you should not use this calculator to calculate
                dps for dice like typhoon, mighty wind. For DPS calculation,
                please use <Link to='/calculator/dps'>dice DPS calculator</Link>{' '}
                instead.
            </p>
            ...
            <hr className='divisor' />
            <p>
                The table below shows the information of upgrading a dice class.
                Copies needed and gold needed mean the cost of upgrading the
                dice to the next level. While contribution to crit damage refers
                to the total critical damage contributed towards you total
                crit%, it does not increase the critical chance of the dice.
            </p>

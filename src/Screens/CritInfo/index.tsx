...
export default function critDataCollection(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                The following data is collected through the community. Please
            ...
            {auth && auth !== 'awaiting auth state' ? (
                <>
                    <p>
                        ...
                        you entered will go live immediately. You do not need to
                        enter your rank, it is calculated automatically based on
                        your trophies.
                    </p>
                    <p>
                        Note that your trophies count should be a positive
                        integer while your crit damage should be between 111 -{' '}
                        {maxCrit}. If you are class 20 or above, your trophies
                        count will be rounded down to 9,000 trophies.
                    </p>
                    <form>
                    ...
                    <tbody>
                        <tr>
                            ...
                            {Object.keys(trophiesForClass)
                                .slice(0, 10)
                                .map(classNum => (
                                    <td key={`crit-table-class-${classNum}`}>
                                        {classNum}
                                    </td>
                                ))}
                        </tr>
                        <tr>
                            ...
                            {Object.values(trophiesForClass)
                                .slice(0, 10)
                                .map(trophies => (
                                    <td key={`crit-table-trophies-${trophies}`}>
                                        {trophies}
                                    </td>
                                ))}
                        </tr>

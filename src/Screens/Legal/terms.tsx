...
export default function Terms(): JSX.Element {
  return (
    <PageWrapper
      className='legal'
      title='Terms and Conditions for Random Dice Community Website'
      disallowAd
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Random Dice Community Website.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Random Dice Community Website,
            accessible from <Link to='/'>https://randomdice.gg/</Link>
          </p>
        </li>
        <li>
          <p>

...
export default function BattlefieldGuide(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                Since patch 5.3.0, battlefield skins now give a unique buff in
                addition to being a cosmetic. The buff given by each individual
                battlefield skin can be viewed below.
            </p>
            <p>
                The battlefield buff effect can be leveled up using gold. The
                maximum level for the battlefield skin is your pvp rank, meaning
                that level 20 is the maximum level for all battlefield skins.
                Below is a table showing the cost to upgrade the battlefield
                skins. It takes a total of{' '}
            ...
            <p>
                In co-op mode, the battlefield from the player with higher pvp
                rank will be used. If both players are the same pvp rank, the
                battlefield used is randomly picked. The only exception is that
                the default light mode battlefield skin is never chosen despite
                one player having higher pvp rank.
            </p>

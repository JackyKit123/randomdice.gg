...
export default function ArenaDraft(): JSX.Element {
    ...
    return (
        ...
        >
            <p>
                This is a Tool for assisting to draft an arena deck. To start
                drafting, input you 3 dice in the section below. Once all 3
                dices are input into the picks section, you can compare the
                value and pick into one of them. Or if you are confident, you
                can skip comparing and use the bypass option below the table.
            </p>
            <p>
                Usually, highest dice role value will result in the best pick.
                If the highest dice role value are equal, the highest dice value
                between them will be the best pick.
            </p>
            <p>
                Take note that dice like typhoon or blizzard may be a good pick
                even if their dice role are low. And you should usually pick
                into typhoon and blizzard.
            </p>
            <p>
                Once you finished picking you deck, we will show a rough
                estimated win rate on the deck based on the deck score of your
                deck.
            </p>
            <p>
                Lastly, do be reminded that the legendary dice is not available
                for the first 2 slots in your deck, the same thing applies for
                this tool.
            </p>
            ...
            <section className='pick'>
                ...
                <div className='manual'>
                    I do not need to compare the value, put this dice into the
                    deck directly:{' '}
                    <form
                        onSubmit={(evt): void => {
                            evt.preventDefault();
                ...
                {Array(12)
                    ...
                    .map((_, i) => (
                        <label htmlFor='win-chance' key={winProb[i] || i}>
                            ...
                            <input
                                type='textbox'
                                value={`${Math.round(winProb[i + 1] * 10000) /
                                    100}%`}
                                disabled
                            />
                        </label>

            ...
            content={
                <>
                    ...
                    <p>
                        ...
                        to the game such as the deck list, calculator and some
                    ...
                    <p>
                        This website uses modern framework and can served while
                        having no internet connection. It can also be easily
                        installed onto your device for convenient access, you
                        can check out how to install in the links here for{' '}
                        <a
                    ...
                    <p>
                        Site Performance is greatly enhanced. Initial loading
                        speed should be decreased. This web page can now also be
                        loaded without internet connection. This web app can now
                        be installed onto your device, method can be seen in the
                        link here for{' '}
                        <a
                            href='https://www.howtogeek.com/fyi/how-to-install-progressive-web-apps-pwas-in-chrome/'
                            target='_blank'
